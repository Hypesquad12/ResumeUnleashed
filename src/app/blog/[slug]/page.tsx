    ...
    <div className="min-h-screen bg-gradient-to-b from-slate-50 via-white to-slate-50">
      ...
      <header className="border-b bg-white/80 backdrop-blur-md sticky top-0 z-50 shadow-sm">
        <div className="container mx-auto px-4 py-4 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
          <Link href="/blog" className="flex items-center gap-2 w-full sm:w-auto">
        ...
        <article className="max-w-5xl mx-auto">
          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-10 pb-8 border-b border-slate-200">
            ...
            <div className="flex flex-wrap items-center gap-2">
              <span className="hidden sm:inline text-sm text-slate-500 sm:mr-2">Share:</span>
              <Button variant="outline" size="icon" className="h-8 w-8 sm:h-9 sm:w-9 rounded-full border-slate-300 hover:bg-slate-100">
