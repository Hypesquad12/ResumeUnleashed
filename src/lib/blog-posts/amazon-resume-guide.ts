export const amazonResumeGuide = {
  slug: 'crafting-perfect-resume-for-amazon',
  title: 'Crafting the Perfect Resume for Amazon: Leadership Principles Guide',
