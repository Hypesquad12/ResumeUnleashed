export const googleResumeGuide = {
  slug: 'crafting-perfect-resume-for-google',
  title: 'Crafting the Perfect Resume for Google: Googleyness and Technical Excellence',
