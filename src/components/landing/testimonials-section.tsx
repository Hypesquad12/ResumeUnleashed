...
const testimonials = [
  ...
  },
  {
    ...
    company: 'Meta',
    content: 'After 3 months of silence, I got 3 interview requests within days of using Resume Unleashed. The ATS score jumped from 45% to 94%.',
    avatar: 'MR',
    rating: 5,
  ...
  },
  {
    ...
    company: 'Amazon',
    content: 'Finally passed the ATS filter after months of rejections. Got 2 offers within 3 weeks of using Resume Unleashed.',
    avatar: 'JW',
    rating: 5,
