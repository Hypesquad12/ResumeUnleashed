...
const features = [
  ...
  },
  {
    ...
    description: 'Get ready for your next interview with realistic, AI-powered mock sessions. Receive real-time feedback and practice with personalized questions.',
    gradient: 'from-emerald-500 to-teal-500',
  },
  {
    icon: MessageSquare,
    title: 'Voice-Based Interview Practice',
    description: 'Practice your interview skills with natural, voice-based conversations. Speak your answers and get instant AI feedback to improve your delivery.',
    gradient: 'from-amber-500 to-orange-500',
  },
  {
    icon: CreditCard,
    title: 'Digital Business Cards',
    description: 'Design a sleek digital business card with your contact information, social media links, and a QR code for easy, instant sharing.',
    gradient: 'from-cyan-500 to-teal-500',
  },
  {
    icon: QrCode,
    title: 'Shareable Links & Analytics',
    description: 'Generate a unique link for your resume and track views and engagement with our built-in analytics dashboard.',
